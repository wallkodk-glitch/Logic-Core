...
export function ProjectEditorPage({ id }: { id: string }) {
  ...
  if (id !== 'new' && !project) return <><PageHeader eyebrow="PROJECTS" title="Projektet findes ikke" /><p className="muted">Det kan være slettet i et andet vindue.</p><a className="button secondary" href="#/projects">Til projekter</a></>;
