...
const modules: Record<string, { title: string; eyebrow: string; icon: IconName; description: string; future: string }> = {
  decisions: { title: 'Beslutninger', eyebrow: 'WORKSPACE / DECISIONS', icon: 'decisions', description: 'Et sted til de valg, der former retningen.', future: 'Beslutningslog og Decision Drift' },
...
export function PlaceholderPage({ page }: { page: 'decisions' | 'opportunities' | 'knowledge' }) {
